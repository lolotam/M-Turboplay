        ...
        <div className="mb-12">
          <div className="bg-gradient-to-r from-[#A855F7]/20 to-[#E935C1]/20 border border-[#A855F7]/30 rounded-2xl p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button className="bg-black hover:bg-gray-800 text-white px-6 py-3 rounded-xl flex items-center gap-3 transition-all duration-300 hover:scale-105">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.71 19.5c-.83 1.24-1.71 2.08-2.7 2.08-1.02 0-1.23-.53-2.29-.53-1.11 0-1.37.53-2.23.53-.98 0-1.82-.73-2.63-2.08-1.17-1.97-2.06-5.58-.86-8.01.58-1.19 1.62-1.94 2.75-1.96.86-.02 1.67.58 2.2.58.52 0 1.5-.72 2.53-.61.43.02 1.64.17 2.41 1.3-.06.04-1.44.84-1.42 2.51.02 1.99 1.76 2.66 1.77 2.67-.02.06-.28.95-1.02 1.87-.66.84-1.35 1.67-2.43 1.69-.98.02-1.3-.58-2.43-.58-1.13 0-1.48.56-2.41.58-1.08.02-1.83-.91-2.49-1.75-1.35-1.73-2.38-4.88-1-7.01.68-1.05 1.9-1.72 3.22-1.74 1.01-.02 1.96.68 2.58.68.62 0 1.78-.84 3-.72.51.02 1.94.21 2.86 1.57-.07.04-1.71 1-1.69 2.98.02 2.37 2.09 3.16 2.1 3.17-.02.07-.33 1.13-1.21 2.23z"/>
                </svg>
